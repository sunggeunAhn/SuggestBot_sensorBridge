...
public class E4_communicator extends AppCompatActivity implements EmpaDataDelegate, EmpaStatusDelegate {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_e4_communicator);
        initE4();
        initNeurosky();
    }
    ...
    public void didDiscoverDevice(EmpaticaDevice bluetoothDevice, String deviceName, int rssi, boolean allowed) {
        ...
        if (allowed) {
            ...
            try {
                ...
                Toast.makeText(E4_communicator.this, "Sorry, you can't connect to this device", Toast.LENGTH_SHORT).show();
            }
        }
    }
