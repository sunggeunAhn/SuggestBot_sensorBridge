...
public class MainActivityOrigin extends AppCompatActivity implements MessageDialogFragment.Listener {

    Socket socket;
    String ip = "143.248.199.56";
    int port = 5000;
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case BluetoothHandlerMessage.MESSAGE_CONNECT:
                    ...
                    serverIntent = new Intent(MainActivityOrigin.this, DeviceListActivity.class);
